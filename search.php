...
$ntype = isset($_GET["type"]) ? $_GET["type"] : "news";
		...
		<div class="header">
			...
			<div class="headerContent">
				...
				<div class="logoContainer">
					<a href="index.php">
						<img src="assets/images/YIMLogo.png">
					</a>
				</div>
				...
				<div class="searchContainer">
					...
					<form action="search.php" method="GET">
						...
						<div class="searchBarContainer">
                            ...
                            <i style="margin: auto; cursor:pointer" class="fas fa-microphone-alt mic"></i>
